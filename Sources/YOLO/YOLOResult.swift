...
public struct Box: @unchecked Sendable {
  ...
  /// The confidence score (0.0 to 1.0) that the bounding box actually contains an object.
  ...
  /// Creates a Box, defaulting detection confidence to the class confidence when not provided.
  public init(
    index: Int,
    cls: String,
    conf: Float,
